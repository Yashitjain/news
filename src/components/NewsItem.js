  ...
  publishDate = new Date(publishDate).toLocaleString(undefined, {timeZone: 'Asia/Kolkata'});
    ...
    return (
      <div style={{border:"1px solid black",width:"18rem"}}>
        ...
        <span class="badge badge-pill badge-danger" style={{color:'black',width:"fit-content",zIndex:"1",position:"absolute",backgroundColor:"red",right:"0px",color:"white"}}>By <span>{source}</span> </span>
        <img src={imageurl} className="card-img-top" alt="..." style={{width:"100%",aspectRatio:"16/9"}}/>
            <div className="card-body" style={{position:"relative"}}>
                ...
                <p className="card-text" style={{width:"100%",height:"4rem"}}>{text}
                  <div style={{width:"fit-content",right:"5px",bottom:"12px",position:"absolute"}}>{(`${publishDate.slice(0,10)}`)}</div>
                </p>
